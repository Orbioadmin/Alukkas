...
namespace Nop.Web.Framework
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            //added by madhu mb 
            builder.RegisterType<OB.Catalog.CategoryService>().As<OB.Catalog.ICategoryService>().InstancePerHttpRequest();
            builder.RegisterType<OB.Seo.UrlRecordService>().As<OB.Seo.IUrlRecordService>().InstancePerHttpRequest();

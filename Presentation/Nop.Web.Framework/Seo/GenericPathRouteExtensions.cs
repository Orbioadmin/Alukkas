...
namespace Nop.Web.Framework.Seo
{
    ...
    public static class CommonPathRouteExtensions
    {
        public static Route MapCommonPathRoute(this RouteCollection routes, string name, string url, object defaults, string[] namespaces)
        {
            if (routes == null)
            {
                throw new ArgumentNullException("routes");
            ...
            var route = new CommonPathRoute(url, new MvcRouteHandler())
            {
                Defaults = new RouteValueDictionary(defaults),

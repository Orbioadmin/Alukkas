    ...
    public partial class CustomerController : BaseNopController
    {
        ...
        public ActionResult Login(bool? checkoutAsGuest)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    result = Request.QueryString["returnUrl"].ToString();
                }
            }
            ViewData["ShowOption"] = (!String.IsNullOrEmpty(result)) ? true : false;
           // ViewData["ShowOption"] = false;
            return View(model);
        }
